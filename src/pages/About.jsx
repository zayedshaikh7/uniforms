      ...
      <section className="section" style={{ background: 'var(--color-bg-mid)' }}>
        <div style={{ maxWidth: 'var(--container-max)', margin: '0 auto', padding: '0 var(--container-padding)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 'var(--space-xl)' }}>
            ...
            <div className={`reveal ${isRevealed(3) ? 'visible' : ''}`} style={{ background: 'white', padding: 'var(--space-xl)', borderRadius: 'var(--card-radius)', boxShadow: 'var(--shadow-card)', textAlign: 'center' }}>
            ...
            <div className={`reveal ${isRevealed(4) ? 'visible' : ''}`} style={{ background: 'white', padding: 'var(--space-xl)', borderRadius: 'var(--card-radius)', boxShadow: 'var(--shadow-card)', textAlign: 'center' }}>
              <div style={{ fontSize: '3rem', marginBottom: 'var(--space-md)' }}>✅</div>
      ...
      <section className="section" style={{ background: 'var(--color-bg-light)' }}>
        <div style={{ maxWidth: 'var(--container-max)', margin: '0 auto', padding: '0 var(--container-padding)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 'var(--space-xl)' }}>
            ...
            <div className={`reveal ${isRevealed(7) ? 'visible' : ''}`} style={{ background: 'white', padding: 'var(--space-xl)', borderRadius: 'var(--card-radius)', boxShadow: 'var(--shadow-card)', borderTop: '3px solid var(--color-accent)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-md)', marginBottom: 'var(--space-md)' }}>
            ...
            <div className={`reveal ${isRevealed(8) ? 'visible' : ''}`} style={{ background: 'white', padding: 'var(--space-xl)', borderRadius: 'var(--card-radius)', boxShadow: 'var(--shadow-card)', borderTop: '3px solid var(--color-accent)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-md)', marginBottom: 'var(--space-md)' }}>
            ...
            <div className={`reveal ${isRevealed(9) ? 'visible' : ''}`} style={{ background: 'white', padding: 'var(--space-xl)', borderRadius: 'var(--card-radius)', boxShadow: 'var(--shadow-card)', borderTop: '3px solid var(--color-accent)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-md)', marginBottom: 'var(--space-md)' }}>
